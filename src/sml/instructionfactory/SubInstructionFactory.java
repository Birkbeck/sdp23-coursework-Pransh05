...
/*This class contain information about sub instruction factory.
 *
 * @author Priya Goel
 */
...
public class SubInstructionFactory implements InstructionFactory{
    ...
    public SubInstructionFactory(Function<String, RegisterName> registerValue) {
    ...
    public Instruction create(String label, Supplier<String> consParam) {
        return new SubInstruction(label, registerValue.apply(consParam.get()),
